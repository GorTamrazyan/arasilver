  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto flex max-w-3xl flex-col items-center px-5 py-20 text-center md:py-32">
        <p className="text-xs tracking-[0.3em] text-muted-foreground uppercase">Оплата прошла</p>
        <h1 className="mt-6 font-serif text-5xl leading-tight text-balance md:text-7xl">
          Спасибо за <em className="font-light italic text-muted-foreground">покупку</em>
        </h1>
        <p className="mt-8 max-w-xl text-base leading-relaxed text-muted-foreground">
          Платёж получен, заказ подтверждён. Мы свяжемся с вами по деталям доставки.
        </p>
