        ...
        <div className="mx-auto max-w-[1400px] px-5 py-16 md:px-10 md:py-24">
          <div className="mb-10">
            <p className="mb-5 flex items-center gap-3 text-xs tracking-[0.3em] text-muted-foreground uppercase">
              ...
              {activeCategory ? CATEGORY_LABELS[activeCategory] : "Каталог"}
            </p>
            <h1 className="font-serif text-5xl leading-tight text-balance md:text-7xl">
              {activeCategory ? (
                ...
                <>
                  Все <em className="font-light italic text-muted-foreground">украшения</em>
                </>
              )}
            </h1>
            <p className="mt-6 max-w-xl text-base leading-relaxed text-muted-foreground">
              Каждое украшение создано вручную из серебра 925 пробы. Уникальные формы, фактура и душа мастера в каждой
              детали.
            </p>
          </div>
          ...
          {products.length > 0 ? (
            ...
            <div className="py-20 text-center">
              <p className="font-serif text-2xl italic text-muted-foreground">В этой категории пока пусто</p>
              <p className="mt-3 text-sm text-muted-foreground">Скоро здесь появятся новые украшения.</p>
            </div>
          )}
        </div>
      </section>
